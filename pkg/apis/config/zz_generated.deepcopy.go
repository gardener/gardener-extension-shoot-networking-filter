...
func (in *EgressFilter) DeepCopyInto(out *EgressFilter) {
	*out = *in
	if in.WorkerSpecific != nil {
		in, out := &in.WorkerSpecific, &out.WorkerSpecific
		*out = new(WorkerSpecific)
		(*in).DeepCopyInto(*out)
	}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *WorkerSpecific) DeepCopyInto(out *WorkerSpecific) {
	*out = *in
	if in.Groups != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new WorkerSpecific.
func (in *WorkerSpecific) DeepCopy() *WorkerSpecific {
	if in == nil {
		return nil
	}
	out := new(WorkerSpecific)
