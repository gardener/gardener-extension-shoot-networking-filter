...
func RegisterConversions(s *runtime.Scheme) error {
	...
	if err := s.AddGeneratedConversionFunc((*WorkerSpecific)(nil), (*config.WorkerSpecific)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_v1alpha1_WorkerSpecific_To_config_WorkerSpecific(a.(*WorkerSpecific), b.(*config.WorkerSpecific), scope)
	}); err != nil {
		return err
	}
	if err := s.AddGeneratedConversionFunc((*config.WorkerSpecific)(nil), (*WorkerSpecific)(nil), func(a, b interface{}, scope conversion.Scope) error {
		return Convert_config_WorkerSpecific_To_v1alpha1_WorkerSpecific(a.(*config.WorkerSpecific), b.(*WorkerSpecific), scope)
	}); err != nil {
		return err
	}
	return nil
...
func autoConvert_v1alpha1_EgressFilter_To_config_EgressFilter(in *EgressFilter, out *config.EgressFilter, s conversion.Scope) error {
	...
	out.WorkerSpecific = (*config.WorkerSpecific)(unsafe.Pointer(in.WorkerSpecific))
...
func autoConvert_config_EgressFilter_To_v1alpha1_EgressFilter(in *config.EgressFilter, out *EgressFilter, s conversion.Scope) error {
	out.BlackholingEnabled = in.BlackholingEnabled
	out.WorkerSpecific = (*WorkerSpecific)(unsafe.Pointer(in.WorkerSpecific))
	out.SleepDuration = (*v1.Duration)(unsafe.Pointer(in.SleepDuration))
...
func autoConvert_v1alpha1_WorkerSpecific_To_config_WorkerSpecific(in *WorkerSpecific, out *config.WorkerSpecific, s conversion.Scope) error {
	out.BlackholingEnabled = in.BlackholingEnabled
	out.Groups = *(*[]string)(unsafe.Pointer(&in.Groups))
	return nil
}

// Convert_v1alpha1_WorkerSpecific_To_config_WorkerSpecific is an autogenerated conversion function.
func Convert_v1alpha1_WorkerSpecific_To_config_WorkerSpecific(in *WorkerSpecific, out *config.WorkerSpecific, s conversion.Scope) error {
	return autoConvert_v1alpha1_WorkerSpecific_To_config_WorkerSpecific(in, out, s)
}

func autoConvert_config_WorkerSpecific_To_v1alpha1_WorkerSpecific(in *config.WorkerSpecific, out *WorkerSpecific, s conversion.Scope) error {
	out.BlackholingEnabled = in.BlackholingEnabled
	out.Groups = *(*[]string)(unsafe.Pointer(&in.Groups))
	return nil
}

// Convert_config_WorkerSpecific_To_v1alpha1_WorkerSpecific is an autogenerated conversion function.
func Convert_config_WorkerSpecific_To_v1alpha1_WorkerSpecific(in *config.WorkerSpecific, out *WorkerSpecific, s conversion.Scope) error {
	return autoConvert_config_WorkerSpecific_To_v1alpha1_WorkerSpecific(in, out, s)
}
