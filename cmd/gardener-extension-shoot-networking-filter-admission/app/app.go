...
import (
	...
	admissioncmd "github.com/gardener/gardener-extension-shoot-networking-filter/pkg/admission/cmd"
)

// ExtensionName is the name of the extension.
const ExtensionName = "shoot-network-filter"

// Name is a const for the name of this component.
const Name = "admission-shoot-network-filter"

// NewControllerManagerCommand creates a new command for running a shoot-network-filter controller.
func NewControllerManagerCommand(ctx context.Context) *cobra.Command {
	var (
		...
		mgrOpts  = &extensionscmdcontroller.ManagerOptions{
			...
			WebhookCertDir:          "/tmp/admission-shoot-network-filter-cert",
		}
